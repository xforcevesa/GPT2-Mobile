...
JNIEXPORT jboolean JNICALL Java_com_xvesa_gpt2mobile_GPT2_loadGPT2(JNIEnv* env, jobject thiz, jobject assetManager, jstring jvocab)
{
...
JNIEXPORT jstring JNICALL Java_com_xvesa_gpt2mobile_GPT2_chat(JNIEnv* env, jobject thiz, jstring in)
{
